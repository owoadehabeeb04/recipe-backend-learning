...
const footerLinks = {
  ...
  features: [
    { href: "/dashboard/all-recipes", label: "Recipe Library" },
...
export function Footer() {
  return (
    <footer className="border-t bg-muted/30 py-10 sm:py-12 md:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-10 mb-8 sm:mb-12">
          <div className="sm:col-span-2 md:col-span-1">
            <h3 className="text-xl sm:text-2xl font-bold text-primary mb-3 sm:mb-4">Recipia</h3>
          ...
          <div>
            <h4 className="font-semibold mb-4 sm:mb-5 text-foreground text-sm sm:text-base">Connect</h4>
        ...
        <div className="pt-6 sm:pt-8 border-t flex flex-col md:flex-row justify-between items-center gap-3 sm:gap-4 text-center md:text-left">
